 ...
 *
 * Reads: data/backtest-v2/events.jsonl
 * Writes: data/backtest-v2/events-enriched.jsonl
 *
...
const EVENTS_IN = path.join(ROOT, "data", "backtest-v2", "events.jsonl");
const EVENTS_OUT = path.join(ROOT, "data", "backtest-v2", "events-enriched.jsonl");
